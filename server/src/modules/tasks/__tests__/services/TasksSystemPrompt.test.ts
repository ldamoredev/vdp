...
import { buildTasksSystemPrompt } from '../../infrastructure/agent/system-prompt';
...
// "today".
describe('buildTasksSystemPrompt', () => {
    beforeEach(() => {
        vi.useFakeTimers();
    });
    ...
    it('reflects the current date on every build', () => {
        ...
        expect(buildTasksSystemPrompt()).toContain('La fecha de hoy es: 2026-06-11');
