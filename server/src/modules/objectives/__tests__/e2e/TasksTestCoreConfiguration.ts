...
/**
 * Boots Objectives together with Tasks so the cross-domain deadline signal
 * (objective event -> task insight/task) runs end to end.
 */
export class TasksTestCoreConfiguration implements CoreConfig {
