...
export async function statsRoutes(app: FastifyInstance) {
  // Summary: total balance by currency, income/expense for month/year
  app.get("/api/v1/stats/summary", async (request, reply) => {
    try {
      ...
      // Total balance per currency (across all active accounts)
      ...
      // Income/expense for the given month/year
  ...
  // Monthly trend: income vs expense for last 12 months
