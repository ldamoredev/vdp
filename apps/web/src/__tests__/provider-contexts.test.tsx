...
function mockCoreProviderDependencies() {
  vi.doMock("@/createAppCore", () => ({
    createAppCore: vi.fn(() => ({})),
  }));
  vi.doMock("@/lib/auth", () => ({
    confirmSessionAfterUnauthorized: vi.fn(),
  }));
}
...
describe("app providers", () => {
  ...
  it("keeps CoreProvider context stable when the module is reloaded", async () => {
    mockCoreProviderDependencies();
  ...
  it("keeps TasksEventsProvider context stable when the module is reloaded", async () => {
  ...
  it("keeps HealthEventsProvider context stable when the module is reloaded", async () => {
