            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <div className="text-xs font-medium uppercase tracking-[0.14em] text-[var(--muted)]">
                  {morning.projectHours.title}
                </div>
                <p className="mt-1 text-sm text-[var(--muted)]">
                  {morning.projectHours.summary}
                </p>
              </div>
              <div className="text-left sm:text-right">
                <div className="text-2xl font-data font-bold text-[var(--foreground)]">
                  {morning.projectHours.totalLabel}
                </div>
              </div>
            </div>
            {morning.projectHours.hasEntries ? (
              <div className="mt-3 space-y-2">
                {morning.projectHours.rows.map((row) => (
                  <div
                    key={row.projectId}
                  ...
                  >
                    ...
                    <span className="shrink-0 font-data text-sm font-medium text-[var(--foreground)]">
                      {row.durationLabel}
                    </span>
                  </div>
                ))}
              ...
              <p className="mt-3 text-xs text-[var(--muted)]">{morning.projectHours.emptyLabel}</p>
            )}
          </div>
