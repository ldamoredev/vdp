...
import { X, Send, Bot, Wrench, Loader2, Heart } from "lucide-react";
    ...
    <div className="w-96 border-l border-[var(--glass-border)] bg-[var(--sidebar)] backdrop-blur-xl flex flex-col h-full animate-slide-in-right">
      ...
      <div className="flex items-center justify-between p-4 border-b border-[var(--glass-border)]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-medium text-sm">Asistente de Salud</span>
      ...
      <div className="flex-1 overflow-auto p-4 space-y-4">
        {messages.length === 0 && (
          <div className="text-center py-12">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500/20 to-teal-600/20 flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-xs text-[var(--muted)] max-w-[250px] mx-auto leading-relaxed">
              Puedo registrar metricas, hacer seguimiento de habitos, recordar medicamentos y mas
            </p>
          </div>
        )}
        {messages.map((msg) => (
          <div key={msg.id}>
            {msg.role === "user" && (
              <div className="flex justify-end">
                <div className="bg-emerald-600 text-white rounded-2xl rounded-br-md px-4 py-2.5 text-sm max-w-[80%] shadow-lg shadow-emerald-500/10">
                  {msg.content}
                </div>
              </div>
            )}
      ...
      >
        <div className="flex gap-2">
          <input
            ...
            placeholder="Registra 8h de sueno, animo 4/5..."
          ...
          <button
            ...
            className="p-2.5 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-xl disabled:opacity-30 hover:shadow-lg hover:shadow-emerald-500/20 transition-all cursor-pointer"
          >
            <Send size={16} />
          </button>
        </div>
